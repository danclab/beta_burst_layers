function simulate_simple_bursts(subj_info, pial_vertex, sim_idx, type, snrdb, varargin)
...
output_data_dir=fullfile(params.base_dir,subj_info.subj_id,'simple_sim',sprintf('snr_%d',snrdb));
...
if sim_idx==1 || exist(reg_file,'file')~=2
    clear jobs
    matlabbatch=[];
