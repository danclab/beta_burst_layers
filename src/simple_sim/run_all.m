...
for idx=1:10
    simulate_simple_bursts(subj_info, pial_vertex, idx, type,...
        'base_dir', fullfile('../../output/data',data_dir),...
        'surf_dir', '../../data/surf', 'mri_dir', '../../data/mri');

    plot_simple_sim_burst_sensor(subj_info, type, idx, 'base_dir',fullfile('../../output/data',data_dir));
    ...
    subj_dir=fullfile('../../output/data',data_dir,subj_info.subj_id,'simple_sim');
...
% Plot results
plot_subject_tc(subj_info, 'base_dir',fullfile('../../output/data',data_dir));