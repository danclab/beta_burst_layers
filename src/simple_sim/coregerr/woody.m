function [out,est_lags]=woody(x,varargin)
%
% [out,est_lags]=woody(x,tol,max_it,est_mthd,xcorr_mthd)
%
% Weighted average using Woody average for a signal
% with jitter. Parameters:
%
% x             Singal measurements. Each COLUMN represents
...
% est_lags      Lags for each measurement for time alignment
%
% %%%Example%%%%
% clear all;clc
% 
