function plot_subjects_tc_loo(subjects, erd_dir, ers_dir, varargin)
...
for i=1:length(subjects)
    subj_idx=setdiff([1:length(subjects)],i);
    plot(times,mean(erd_subj_mean_source_tcs(subj_idx,:)).'*1000);
end
ylim([-200 150]);
...
for i=1:length(subjects)
    subj_idx=setdiff([1:length(subjects)],i);
    plot(times,mean(ers_subj_mean_source_tcs(subj_idx,:))'.*1000);
end
ylim([-200 150]);
xlim([sliding_tc_times(1) sliding_tc_times(end)]);
ylabel('pAm/mm^2');
...
for i=1:length(subjects)
    subj_idx=setdiff([1:length(subjects)],i);
    plot(sliding_tc_times,sum(erd_subj_mean_fdiffs(subj_idx,:),1));
end
...
for i=1:length(subjects)
    subj_idx=setdiff([1:length(subjects)],i);
    plot(sliding_tc_times,sum(ers_subj_mean_fdiffs(subj_idx,:),1));
end
plot([sliding_tc_times(1) sliding_tc_times(end)],[3 3],'k--');
plot([sliding_tc_times(1) sliding_tc_times(end)],[-3 -3],'k--');
xlim([sliding_tc_times(1) sliding_tc_times(end)]);
...
for i=1:length(subjects)
    subj_idx=setdiff([1:length(subjects)],i);
    plot(erd_aligned_times,mean(erd_aligned_tcs(subj_idx,:))'.*1000);
end
ylim([-200 200]);
xlim([sliding_tc_times(1) sliding_tc_times(end)]);
ylabel('pAm/mm^2');
...
for i=1:length(subjects)
    subj_idx=setdiff([1:length(subjects)],i);
    plot(ers_aligned_times,mean(ers_aligned_tcs(subj_idx,:))'.*1000);
end
ylim([-200 200]);
xlim([sliding_tc_times(1) sliding_tc_times(end)]);
ylabel('pAm/mm^2');
...
for i=1:length(subjects)
    subj_idx=setdiff([1:length(subjects)],i);
    plot(erd_aligned_sliding_tc_times,sum(erd_aligned_mean_f_diffs(subj_idx,:),1));
end
plot([sliding_tc_times(1) sliding_tc_times(end)],[3 3],'k--');
plot([sliding_tc_times(1) sliding_tc_times(end)],[-3 -3],'k--');
xlim([sliding_tc_times(1) sliding_tc_times(end)]);
...
for i=1:length(subjects)
    subj_idx=setdiff([1:length(subjects)],i);
    plot(ers_aligned_sliding_tc_times,sum(ers_aligned_mean_f_diffs(subj_idx,:),1));
end
plot([sliding_tc_times(1) sliding_tc_times(end)],[3 3],'k--');
plot([sliding_tc_times(1) sliding_tc_times(end)],[-3 -3],'k--');
xlim([sliding_tc_times(1) sliding_tc_times(end)]);
