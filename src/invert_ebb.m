function invert_ebb(subj_info, data_file, coreg_fname, mesh_fname, varargin)

defaults = struct('surf_dir', '../data/surf', 'mri_dir', '../data/mri',...
    'patch_size', 5, 'n_temp_modes', 4);  %define default values
