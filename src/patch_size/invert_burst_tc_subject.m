...
if length(params.plot_dir)==0
    params.plot_dir=fullfile('../../output/figures',base_dir_parts{end},...
        ...
        sprintf('patch_size_%.2f', params.patch_size));
end
...
save(fullfile(data_dir, sprintf('invert_burst_tc_results_%.2f_patch_size.mat', params.patch_size)), 'invert_burst_tc_results');
