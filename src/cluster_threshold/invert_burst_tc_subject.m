function invert_burst_tc_subject(subj_info, cluster_threshold, varargin)
...
% Run EBB localizer
pial_clusters=invert_burst_subject(subj_info, cluster_threshold,...
...
save(fullfile(data_dir, sprintf('invert_burst_tc_results_%.2f_cluster_thresh.mat',cluster_threshold)), 'invert_burst_tc_results');
